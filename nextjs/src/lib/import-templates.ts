...
const TEMPLATES: Record<string, { headers: string[]; sampleRows: string[][]; notes: string[] }> = {
  customers: {
    ...
    notes: [
      ...
      '"Who Acquired: YOWI | RCBC Partner | Globe Partner | TAI | PEI"',
      '"Entity: YAHSHUA | ABBA"',
      ...
      '"Bank Account: e.g. Main Account, RCBC Current. Leave blank for Main Account."',
    ],
  },
  vendors: {
    headers: [
  ...
  balances: {
    ...
    notes: [
      ...
      '"Entity: YAHSHUA | ABBA"',
      '"Account Name: e.g. Main Account, RCBC Current, BDO Savings"',
